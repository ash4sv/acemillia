    ...
    <!-- Vendors JS -->
    <script src="{{ asset('apps/vendor/libs/@form-validation/popular.js') }}"></script>
    <script src="{{ asset('apps/vendor/libs/@form-validation/bootstrap5.js') }}"></script>
    <script src="{{ asset('apps/vendor/libs/@form-validation/auto-focus.js') }}"></script>

    <!-- Main JS -->
    <script src="{{ asset('apps/js/main.js') }}"></script>

    <!-- Page JS -->
    {{--<script src="{{ asset('apps/js/pages-auth.js') }}"></script>--}}
