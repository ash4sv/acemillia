...
<script>
    $(document).ready(function() {
        $('#category-select, #tags, #sub_category').selectize({
            create: true,
            sortField: 'text',
        });
        ...
        function loadSubCategories(categoryId) {
            ...
            var url = "{{ route('merchant.categories.subcategories', ['category' => ':id']) }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.length > 0) {
                        ...
                        html += '<select name="sub_category" id="sub_category" class="">';
...
@section('user-apps-content')
    ...
    <div class="dashboard-box">
        <div class="dashboard-title">
            <h4>{!! __( isset($product) ? 'Edit':'Create') . ' Product' !!}</h4>
            <a class="ms-auto" href="{!! route('merchant.dashboard', ['section' => 'products']) !!}"><span>{!! __('Back') !!}</span></a>
        </div>
        <div class="dashboard-detail">
            ...
            <form action="{{ isset($product) ? route( $route . 'update', $product->id) : route( $route . 'store') }}" enctype="multipart/form-data" class="mb-0" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="categories" id="category-select" class="">
                ...
                <div class="mb-3">
                    ...
                    <select name="tags[]" id="tags" class="" multiple>
                        <option value="">Select value</option>
                        @php
