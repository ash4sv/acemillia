...
@section('keywords', '')
@section('author', '')
@section('title', 'Become a Merchant')
...
@section('webpage')
    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="banner-section"><img src="{{ asset('assets/images/about/vendor.jpg') }}" class="img-fluid blur-up lazyload"
                    alt="">
                    ...
                    <div class="col-lg-4">
                        <div class="step-box">
                            <div>
                                ...
                                <p>Register your business for free and create a product catalogue. Sell under your own private label or sell an existing brand. Get your documentation & cataloging done with ease from our Professional Services network.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="step-box">
                            <div>
                                ...
                                <p>Once listed, your products will be available to millions of users.Get orders and manage your online business via our Seller Panel and Seller Zone Mobile App.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="step-box">
                            <div>
                                ...
                                <p>Receive quick and hassle-free payments in your account once your orders are fulfilled. Expand your business with low interest & collateral-free loans.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="start-selling section-b-space">
        <div class="container">
            <div class="col">
                <div>
                    <h4>start selling</h4>
                    <p>Multikart marketplace is India's leading platform for selling online. Be it a manufacturer, vendor or supplier, simply sell your products online on Multikart and become a top ecommerce player with minimum investment. Through a team of experts offering exclusive seller workshops, training, seller support and convenient seller portal, Multikart focuses on educating and empowering sellers across India. Selling on Multikart.com is easy and absolutely free. All you need is to register, list your catalogue and start selling your products.</p>
                    <a href="{{ route('merchant.login') }}" class="btn btn-solid btn-sm">start selling</a>
                </div>
            </div>
        </div>
    </section>
