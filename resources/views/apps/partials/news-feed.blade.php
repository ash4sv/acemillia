@php
    ...
    $isAdmin    = Auth::guard('admin')->check() && Auth::guard('admin')->user();
    $isMerchant = Auth::guard('merchant')->check() && Auth::guard('merchant');
    $isUser     = Auth::guard('web')->check() && Auth::guard('web')->user();

    $routeNewsFeed        = 'admin.news-feed.';
    $routeNewsFeedComment = 'admin.news-feed-comment.';
    $routeNewsFeedLike    = 'admin.news-feed-like.';
    if ($isUser) {
        $routeNewsFeed        = 'user.news-feed.';
        $routeNewsFeedComment = 'user.news-feed-comment.';
        $routeNewsFeedLike    = 'user.news-feed-like.';
    } elseif ($isMerchant) {
        $routeNewsFeed        = 'merchant.news-feed.';
        $routeNewsFeedComment = 'merchant.news-feed-comment.';
        $routeNewsFeedLike    = 'merchant.news-feed-like.';
    }
        ...
        <div class="aces-feed-item shadow-sm" data-news-feed-id="{{ __($newsfeed->id) }}">
                ...
                <div class="aces-dropdown ms-auto">
                    ...
                    <div class="aces-dropdown-content">
                        <ul>
                            ...
                            <li>Help</li>
                            <li>
                                <a href="{{ route($routeNewsFeed . 'destroy', $newsfeed->id) }}" data-confirm-delete="true">
                                    {{ __('Delete News Feed') }}
                                </a>
                            </li>
                        </ul>
            ...
            <div class="aces-feed-actions">
                <button class="aces-like-btn"
                        data-likes-store="{{ route($routeNewsFeedLike . 'store') }}"
            ...
            <div class="aces-feed-comments">
                ...
                <div class="aces-add-comment">
                    ...
                    <div class="aces-add-comment-input-wrapper"
                         ...
                         data-action-store="{{ route($routeNewsFeedComment . 'store') }}"
...
<div class="modal fade" id="postModal" tabindex="-1" aria-labelledby="postModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content aces-content" data-news-feed-store="{{ route($routeNewsFeed . 'store') }}" data-csrf="{{ csrf_token() }}">
