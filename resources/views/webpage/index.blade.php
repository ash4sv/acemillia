...
@section('keywords', '')
@section('author', '')
@section('title', 'Welcome to Acemillia Marketing')
...
@section('webpage')
            ...
            <div class="row order-section">
                ...
                <div class="col-sm-4 p-0">
                    <div class="contain-block even">
                        <div>
                            <h6>{!! __('new products') !!}</h6>
                            <a href="category-page.html">
                                <h2>{!! __('zipper storage bag') !!}</h2>
                            </a>
                ...
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>{!! __('free shipping world wide') !!}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>{!! __('24 X 7 service') !!}</h4>
                            <p>{!! __('online service for new customer') !!}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>{!! __('new online special festival offer') !!}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="title1  section-t-space">
                    <h4>{!! __('Recent Story') !!}</h4>
                    <h2 class="title-inner1">{!! __('from the blog') !!}</h2>
                </div>
            </div>
        </div>
    </div>
