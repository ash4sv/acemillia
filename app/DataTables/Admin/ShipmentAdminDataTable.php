...
class ShipmentAdminDataTable extends DataTable
{
    protected string $route = 'admin.shipping-service.shipment.';
    ...
    {
        return $this->builder()
                    ->setTableId('shipment-admin-table')
    ...
    {
        return 'ShipmentAdmin_' . date('YmdHis');
    }
}
