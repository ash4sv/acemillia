...
class WidgetAdminDataTable extends DataTable
{
     ...
     */
    public function query(Widget $model): QueryBuilder
    {
    ...
    {
        return 'WidgetAdmin_' . date('YmdHis');
    }
}
