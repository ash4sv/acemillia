...
class ShippingProviderAdminDataTable extends DataTable
{
    protected string $route = 'admin.shipping-service.shipping-provider.';
     ...
     */
    public function query(ShippingProvider $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('shipping-provider-admin-table')
    ...
    {
        return 'ShippingProviderAdmin_' . date('YmdHis');
    }
}
