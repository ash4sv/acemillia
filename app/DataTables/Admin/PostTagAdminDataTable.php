...
class PostTagAdminDataTable extends DataTable
{
    protected string $route = 'admin.blog.tags.';
     ...
     */
    public function query(PostTag $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('post-tag-admin-table')
                    ...
                    ->parameters(array_merge(
                        ...
                        [
                            'buttons'    => [
                                Button::make('reload'),
                                DataTableParameter::createBtn('Create Post Tag', route($this->route . 'create')),
                            ],
                        ]
                    ));
    }
    ...
    {
        return 'PostTagAdmin_' . date('YmdHis');
    }
}
