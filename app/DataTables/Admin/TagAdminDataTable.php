...
class TagAdminDataTable extends DataTable
{
    protected string $route = 'admin.shop.tags.';
        ...
        return $this->builder()
                    ...
                    ->parameters(array_merge(
                        ...
                        [
                            'buttons'    => [
                                Button::make('reload'),
                                DataTableParameter::createBtn('Create Tag', route($this->route . 'create')),
                            ],
                        ]
                    ));
    }
