...
class CategoryAdminDataTable extends DataTable
{
    protected string $route = 'admin.shop.categories.';
    ...
    {
        return $this->builder()
                    ->setTableId('category-admin-table')
                    ...
                    ->parameters(array_merge(
                        ...
                        [
                            'buttons'    => [
                                Button::make('reload'),
                                DataTableParameter::createBtn('Create Category', route($this->route . 'create')),
                            ],
                        ]
                    ));
    }
    ...
    {
        return 'CategoryAdmin_' . date('YmdHis');
    }
}
