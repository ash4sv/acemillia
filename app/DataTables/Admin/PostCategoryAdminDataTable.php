...
class PostCategoryAdminDataTable extends DataTable
{
    protected string $route = 'admin.blog.categories.';
    ...
    {
        return $this->builder()
                    ->setTableId('postcategoryadmin-table')
                    ...
                    ->parameters(array_merge(
                        ...
                        [
                            'buttons'    => [
                                Button::make('reload'),
                                DataTableParameter::createBtn('Create Post Category', route($this->route . 'create')),
                            ],
                        ]
                    ));
    }
    ...
    {
        return 'PostCategoryAdmin_' . date('YmdHis');
    }
}
