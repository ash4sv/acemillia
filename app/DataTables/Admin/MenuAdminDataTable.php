...
class MenuAdminDataTable extends DataTable
{
     ...
     */
    public function query(MenuSetup $model): QueryBuilder
    {
        ...
        return $this->builder()
                    ...
                    ->parameters(array_merge(
                        ...
                        [
                            'buttons'    => [
                                Button::make('reload'),
                                DataTableParameter::createBtn('Create Menu', route($this->route . 'create')),
                            ],
                        ]
                    ));
    }
